...
d.setMagFilter(osg.Texture.LINEAR);d.setWrapS(osg.Texture.REPEAT);d.setWrapT(osg.Texture.CLAMP_TO_EDGE);d.setFlipY(!1);b._mainTrans.getOrCreateStateSet().setTextureAttributeAndModes(DPF_BASE_UNIT,d);console.log("Videopano "+b._panoPath+" loaded.");b._bLoading[0]=!1;b._bLoaded[0]=!0;a.play()}.bind(b))}else{var d=new osg.Texture;(function(a,c){osgDB.readImageURL(a).then(function(e){d.setImage(e);d.setMinFilter(osg.Texture.LINEAR_MIPMAP_LINEAR);d.setMagFilter(osg.Texture.LINEAR);d.setWrapS(osg.Texture.REPEAT);
d.setWrapT(osg.Texture.CLAMP_TO_EDGE);d.setFlipY(!1);b._mainTrans.getOrCreateStateSet().setTextureAttributeAndModes(DPF_BASE_UNIT,d);console.log("Pano texture "+a+" loaded.");b._bLoading[0]=!1;b._bLoaded[0]=!0;c()})})(b._panoPath,function(){b._bLoading[0]=!1;b._bLoaded[0]=!0})}},requestColor:function(a){return this.requestPano(a)},requestDepth:function(a){if(!this._useUnifiedLayout){var b=this;b._bLoading[1]=!0;void 0!==a&&b.setDepthPath(a);if(void 0!==b._depthPath)if(b._isDepthVid){b._depthVidElem=
...
b._mainTrans.getOrCreateStateSet().setTextureAttributeAndModes(DPF_SEM_UNIT,c);console.log("Annotation texture "+b._annPath+" loaded.");b._bLoading[2]=!1;b._bLoaded[2]=!0})}},playVideoStreams:function(){void 0!==this._panoVidElem&&this._panoVidElem.play();void 0!==this._depthVidElem&&this._depthVidElem.play();void 0!==this._annVidElem&&this._annVidElem.play();this._isVideoStreamOnPlay=!0},pauseVideoStreams:function(){void 0!==this._panoVidElem&&this._panoVidElem.pause();void 0!==this._depthVidElem&&
...
a._annXYquery[0]=c;a._annXYquery[1]=b}};Hammer(a._canvas).on("tap",function(b){a._useMobile||a._triggerAnnSelect()});Hammer(a._canvas).on("doubletap",function(b){a.goNextDPFinView(1);a._useMobile&&a._triggerAnnSelect()});a._bDragging=!1;a._bPointerDown=!1;var d=function(b){a._bDragging=!1;a._bPointerDown=!0;c(b)},e=function(b){a._bPointerDown&&(a._bDragging=!0);a._useMobile||a._vrState||a._useDeviceOrientation||c(b)},f=function(b){a._bDragging=!1;a._bPointerDown=!1},h=function(b){a._bDragging=!1;
...
this._insightModel.getOrCreateStateSet().setTextureAttributeAndModes(0,DPFutils.fallbackWhiteTex);this._insightModel.getOrCreateStateSet().setRenderingHint("TRANSPARENT_BIN");this._insightModel.getOrCreateStateSet().setAttributeAndModes(new osg.BlendFunc,osg.StateAttribute.ON);this._insightModel.getOrCreateStateSet().setAttributeAndModes(new osg.Depth(osg.Depth.ALWAYS),osg.StateAttribute.OVERRIDE|osg.StateAttribute.ON);this._insightTrans=new osg.AutoTransform;this._insightTrans.setPosition([0,0,0]);
this._insightTrans.setAutoRotateToScreen(!0);this._insightTrans.addChild(this._insightModel);this._dpfGroup.addChild(this._insightTrans);this._insightTrans.setNodeMask(0)},_update3Dpointer:function(){this._pointerPos[0]=this._hoverAnnDepth*this._direction[0];this._pointerPos[1]=this._hoverAnnDepth*this._direction[1];this._pointerPos[2]=this._hoverAnnDepth*this._direction[2];this._pointerPos[0]+=this._eyePos[0];this._pointerPos[1]+=this._eyePos[1];this._pointerPos[2]+=this._eyePos[2];this._pointerTrans.setPosition(this._pointerPos)},
_updateInsightDPF:function(){var a=this._dpfList[this._inviewDPFid];void 0!==a&&(this._preloadDPF(a),this._insightTrans.setPosition(a._position),this._insightTrans.setNodeMask(15))},initRTT:function(){if(void 0!==this._viewer.getCamera()){this._aRTT=new osg.Camera;this._aRTT.addChild(this._annVisionGroup);this._aRTT.setName("rttCamera");this._aRTT.setClearColor(osg.vec4.create([0,0,0,1]));this._aRTT.setViewMatrix(this._viewer.getCamera().getViewMatrix());this._aRTT.setProjectionMatrix(this._viewer.getCamera().getProjectionMatrix());
