...
function(a){d._useUnifiedLayout&&(a="#define DPF_USE_UNIFIED 1\n"+a);d._useMobile&&(a="#define DPF_MOBILE_DEVICE 1\n"+a);a+="\n";a=new osg.Program(new osg.Shader("VERTEX_SHADER","#define VERTEX_SH 1\n"+a),new osg.Shader("FRAGMENT_SHADER","#define FRAGMENT_SH 1\n"+a));d._glslProgram=a;d.onGLSLprogramLoaded();void 0!==c&&c()},"text")},onGLSLprogramLoaded:function(){if(void 0!==this._glslProgram){for(var a=0;a<this._dpfList.length;a++)this._dpfList[a].setGLSLprogram(this._glslProgram),this._useUnifiedLayout&&
(this._dpfList[a]._useUnifiedLayout=!0);console.log("GLSL Program Loaded")}},setupFallbacks:function(){this._stdVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_PANO_UNIT,DPFutils.fallbackWhiteTex);this._stdVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_DEPTH_UNIT,DPFutils.fallbackBlackTex);this._stdVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_ANN_UNIT,DPFutils.fallbackBlackTex);this._annVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_PANO_UNIT,
DPFutils.fallbackBlackTex);this._annVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_DEPTH_UNIT,DPFutils.fallbackBlackTex);this._annVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_ANN_UNIT,DPFutils.fallbackBlackTex);console.log("Fallbacks set")},home:function(){if(0==this._dpfList.length||void 0===this._dpfList[0])this._manip.setEyePosition([0,0,0]),this._manip.setTarget([0,10,0]);else{var a=void 0===this._activeDPF?this._dpfList[0].getPosition():this._activeDPF.getPosition();
this._manip.setEyePosition(a)}this._manip.setNode(this._dpfGroup)},goExternalView:function(){if(void 0!==this._activeDPF){var a=this._activeDPF.getPosition(),b=this._activeDPF.getDepthRange()[1],c=osg.vec3.create();c[0]=a[0]+1*b;c[1]=a[1]+1*b;c[2]=a[2]+.5*b;this._manip.setEyePosition(c);this._manip.setTarget(a)}},setFOV:function(a){this._fov=a;if(void 0!==this._viewer){var b=this._viewer.getCamera();if(void 0!==b){var c={};osg.mat4.getPerspective(c,b.getProjectionMatrix());osg.mat4.perspective(b.getProjectionMatrix(),
DPF_DEG2RAD*a,c.aspectRatio,c.zNear,c.zFar)}}},getFOV:function(){return this._fov},setDOF:function(a){this._DOFweight=a},getDOF:function(){return this._DOFweight},addDPF:function(a){this._dpfList.push(a);this._stdVisionGroup.addChild(a.getTransNode());this._annVisionGroup.addChild(a.getTransNode());void 0!==this._glslProgram&&a.setGLSLprogram(this._glslProgram);console.log("Added new DPF")},getDPF:function(a){return this._dpfList[a]},getDPFbyName:function(a){for(var b=0;b<this._dpfList.length;b++)if(this._dpfList[b]._uniqueName===
a)return this._dpfList[b]},getNumDPFs:function(){return this._dpfList.length},useUnifiedLayout:function(a){this._useUnifiedLayout=a},isUsingUnifiedLayout:function(){return this._useUnifiedLayout},requestTransitionToLocation:function(a,b){0<=this._tMoveReq||(this._tMoveReq=this._time,this._tMoveDur=b,this._reqTo=a,this._reqFrom=this._eyePos)},duringTransition:function(){return 0<=_tMoveReq},requestTransitionToDPF:function(a,b){if(void 0!==this._manip&&void 0!==a){console.log("Requested transition to "+
a._uniqueName);if(void 0!==this.onTransitionRequest)this.onTransitionRequest();void 0===b?this._manip.setEyePosition(a.getPosition()):this.requestTransitionToLocation(a.getPosition(),b)}},requestTransitionToDPFbyIndex:function(a,b){a=this._dpfList[a];void 0!==a&&this.requestTransitionToDPF(a,b)},requestTransitionToDPFbyName:function(a,b){a=this.getDPFbyName(a);void 0!==a&&this.requestTransitionToDPF(a,b)},requestOrientationByDirection:function(a,b,c){this._vrState||(this._manip.setTarget(osg.vec3.fromValues(a,
b,c)),console.log("\x3e\x3e\x3e Requested orientation by direction: "+a+", "+b+", "+c))},requestOrientationToDPF:function(a){void 0!==a&&this.requestOrientationByDirection(a._position[0],a._position[1],a._position[2])},requestOrientationToDPFbyName:function(a){a=this.getDPFbyName(a);this.requestOrientationToDPF(a)},parseXML:function(a,b){var c=a.substring(0,a.lastIndexOf("/")+1),d=void 0,e=void 0,f=void 0,h=this;console.log("Loading XML: "+a+"...");$.get(a,function(a){c+=$(a).find("basepath").text();
var g=$(a).find("postfix");void 0!==g&&(void 0!==g.attr("color")&&(d=g.attr("color")),void 0!==g.attr("depth")&&(e=g.attr("depth")),void 0!==g.attr("annotation")&&(f=g.attr("annotation")));$(a).find("DPF").each(function(a){a=new DPF;h.addDPF(a);console.log("Parsing DPF...");var b=$(this).find("position");void 0!==b.attr("x")&&void 0!==b.attr("y")&&void 0!==b.attr("z")&&a.setPosition([parseFloat(b.attr("x")),parseFloat(b.attr("y")),parseFloat(b.attr("z"))]);b=$(this).find("orientation");void 0!==b.attr("x")&&
void 0!==b.attr("y")&&void 0!==b.attr("z")&&a.setOrientationFromEulerVector([parseFloat(b.attr("x")),parseFloat(b.attr("y")),parseFloat(b.attr("z"))]);b=$(this).find("name");void 0!==b&&(b=b.text(),a.setUniqueName(b),d&&a.setPanoPath(c+b+d,c+"lo_"+b+d),e&&a.setDepthPath(c+b+e),f&&a.setSemanticPath(c+b+f));b=$(this).find("depthrange");void 0!==b&&void 0!==b.attr("min")&&void 0!==b.attr("max")&&a.setDepthRange(parseFloat(b.attr("min")),parseFloat(b.attr("max")))});h.home();void 0!==b&&b()}).fail(function(){console.log("ERROR Loading XML")})},
_preloadDPF:function(a){void 0!==a&&(a._bLoaded[0]||a._bLoading[0]||a.requestPano(),this._useUnifiedLayout||(a._bLoaded[1]||a._bLoading[1]||a.requestDepth(),a._bLoaded[2]||a._bLoading[2]||a.requestSemantic()))},inVRmode:function(){return this._vrState},toggleVR:function(){var a=this._viewer;a.getVRDisplay()?a.setPresentVR(!this._vrState).then(this._switchVR.bind(this)):this._switchVR()},_switchVR:function(){var a=this._viewer;a.setPresentVR(!this._vrState);if(this._vrState)a._eventProxy.WebVR.setEnable(!1),
a._eventProxy.DeviceOrientation.setEnable(!1),this._root.removeChild(this._vrNode),this._root.addChild(this._dpfGroup),this._pointerTrans.setNodeMask(0);else for(this._root.removeChild(this._dpfGroup),this._vrNode||(navigator.getVRDisplays?(a.getEventProxy().WebVR.setEnable(!0),this._vrNode=osgUtil.WebVR.createScene(a,this._dpfGroup,a._eventProxy.WebVR.getHmd())):(a.getEventProxy().DeviceOrientation.setEnable(!0),this._vrNode=osgUtil.WebVRCustom.createScene(a,this._dpfGroup,{isCardboard:!0,vResolution:this._canvas.height,
hResolution:this._canvas.width}))),this._root.addChild(this._vrNode),this._annXYquery=[.5,.5],this._pointerTrans.setNodeMask(15),this.home(),a=0;a<this._vrNode.children.length;a++)this._vrNode.children[a]._nearFarRatio=this._NFR;this._vrState=!this._vrState}};