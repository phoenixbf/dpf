...
a[0];this._DIMcolor[1]=a[1];this._DIMcolor[2]=a[2]},setDIMweight:function(a){this._DIMweight=a},goNextDPFinView:function(a){if(!(2>this.getNumDPFs())){var b=this._inviewDPFid;0>b||(a=void 0===a?1:a,this.requestTransitionToDPF(this.getDPF(b),a))}},_triggerAnnSelect:function(){if(void 0!==this._activeDPF&&0!==this._hoverAnn){if(void 0!==this.onSelectAnnotation)this.onSelectAnnotation();var a=this._activeDPF._annotationList[this._hoverAnn];if(void 0!==a&&void 0!==a.onSelect)a.onSelect()}},_attachListeners:function(){var a=
