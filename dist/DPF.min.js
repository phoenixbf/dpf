...
2,DPF_X_AXIS);this._baseGeomT=new osg.MatrixTransform;this._baseGeomT.setMatrix(a);this._baseGeomT.setCullingActive(!1);this._baseGeomT.addChild(this._baseGeom);this._mainTrans.addChild(this._baseGeomT)},requestPano:function(a){var b=this;b._bLoading[0]=!0;void 0!==a&&b.setPanoPath(a);if(void 0!==b._panoPath)if(b._isPanoVid){b._panoVidElem=document.createElement("video");b._panoVidElem.style.display="none";var c=new osg.ImageStream(b._panoVidElem);b._panoVidElem.preload="auto";b._panoVidElem.loop=
!0;b._panoVidElem.crossOrigin="anonymous";b._panoVidElem.src=b._panoPath;c.whenReady().then(function(a){var d=new osg.Texture;d.setImage(c);d.setMinFilter(osg.Texture.LINEAR);d.setMagFilter(osg.Texture.LINEAR);d.setWrapS(osg.Texture.REPEAT);d.setWrapT(osg.Texture.CLAMP_TO_EDGE);d.setFlipY(!1);b._mainTrans.getOrCreateStateSet().setTextureAttributeAndModes(DPF_PANO_UNIT,d);console.log("Videopano "+b._panoPath+" loaded.");b._bLoading[0]=!1;b._bLoaded[0]=!0;a.play()}.bind(b))}else{var d=new osg.Texture;
(function(a,c){osgDB.readImageURL(a).then(function(e){d.setImage(e);d.setMinFilter(osg.Texture.LINEAR_MIPMAP_LINEAR);d.setMagFilter(osg.Texture.LINEAR);d.setWrapS(osg.Texture.REPEAT);d.setWrapT(osg.Texture.CLAMP_TO_EDGE);d.setFlipY(!1);b._mainTrans.getOrCreateStateSet().setTextureAttributeAndModes(DPF_PANO_UNIT,d);console.log("Pano texture "+a+" loaded.");b._bLoading[0]=!1;b._bLoaded[0]=!0;c()})})(b._panoPath,function(){b._bLoading[0]=!1;b._bLoaded[0]=!0})}},requestColor:function(a){return this.requestPano(a)},
...
e.setAttribute("pagespeed-no-transform","true");c.setImage(a);c.setMinFilter("NEAREST");c.setMagFilter("NEAREST");c.setWrapS(osg.Texture.REPEAT);c.setWrapT(osg.Texture.CLAMP_TO_EDGE);c.setFlipY(!1);b._mainTrans.getOrCreateStateSet().setTextureAttributeAndModes(DPF_ANN_UNIT,c);console.log("Annotation texture "+b._annPath+" loaded.");b._bLoading[2]=!1;b._bLoaded[2]=!0})}},playVideoStreams:function(){void 0!==this._panoVidElem&&this._panoVidElem.play();void 0!==this._depthVidElem&&this._depthVidElem.play();
...
for(var c=0;c<b;c++){var d=a._dpfList[c],e=d.getPosition();d.setVisibility(0);osg.vec3.sub(this._vE,a._eyePos,e);var f=osg.vec3.squaredDistance(a._eyePos,e);1<f&&(osg.vec3.normalize(this._vE,this._vE),-.8>osg.vec3.dot(a._direction,this._vE)&&f<this._distView&&(a._inviewDPFid=c,this._distView=f));osg.vec3.lerp(this._focP,a._eyePos,a._pointerTrans.getPosition(),.01);osg.vec3.sub(this._vD,this._focP,e);e=osg.vec3.squaredDistance(this._focP,e);e<this._distTarg&&(this._distTarg=e,a._closestDPF=d,a._closestDPFid=
c)}a._closestDPF.setVisibility(1);a._preloadDPF(a._closestDPF);0<=a._inviewDPFid&&1<b&&a._updateInsightDPF();0<=a._tMoveReq&&(this._tReqNorm=(a._time-a._tMoveReq)/a._tMoveDur,1<=this._tReqNorm?(a._tMoveReq=-1,a._eyePos[0]=a._reqTo[0],a._eyePos[1]=a._reqTo[1],a._eyePos[2]=a._reqTo[2],a._targPos[0]=a._eyePos[0]+a._direction[0],a._targPos[1]=a._eyePos[1]+a._direction[1],a._targPos[2]=a._eyePos[2]+a._direction[2],a._inviewDPFid=-1,a._insightTrans.setNodeMask(0)):(this._tReqNorm=(1-Math.cos(this._tReqNorm*
Math.PI))/2,osg.vec3.lerp(a._eyePos,a._reqFrom,a._reqTo,this._tReqNorm)));a._manip.setEyePosition(a._eyePos);if(void 0!==a.onTick)a.onTick();return!0}};
...
(d=e.getGraphicContext(),d.checkFramebufferStatus(d.FRAMEBUFFER)===d.FRAMEBUFFER_COMPLETE)){d.readPixels(0,0,a._aRTTcanvasElem.width,a._aRTTcanvasElem.height,d.RGBA,d.UNSIGNED_BYTE,a._aRTTpixels);a._tLastRTT=a._time;var f=Math.floor(a._aRTTcanvasElem.height*a._annXYquery[1])*b+4*Math.floor(a._aRTTcanvasElem.width*a._annXYquery[0]);e=a._aRTTpixels[f];f=a._aRTTpixels[f+1];a._closestDPF&&(a._dNorm=f/255,f=a._closestDPF.getDepthRange(),a._hoverAnnDepth=DPFutils.lerp(f[1],f[0],a._dNorm),a._hoverAnnDepth-=
f[0]);e=Math.floor(e*DPF_ANN_HASH);e!==a._hoverAnn&&(a._hoverAnn=e,a._onChangeAnnotation())}})}},getHoveredAnnotationID:function(){return this._hoverAnn},_onChangeAnnotation:function(){this._ssGlobal.getUniform("annotationHash").setInt(this._hoverAnn);if(0<this._hoverAnn){if(void 0!==this.onHoverAnnotation)this.onHoverAnnotation();var a=this._closestDPF._annotationList[this._hoverAnn];if(void 0!==a&&void 0!==a.onHover)a.onHover();this._vrState||(this._canvas.style.cursor="pointer")}else if(this._vrState||
...
a);c._useMobile&&(a="#define DPF_MOBILE_DEVICE 1\n"+a);a+="\n";a=new osg.Program(new osg.Shader("VERTEX_SHADER","#define VERTEX_SH 1\n"+a),new osg.Shader("FRAGMENT_SHADER","#define FRAGMENT_SH 1\n"+a));c._glslProgram=a;c.onGLSLprogramLoaded()},"text")},onGLSLprogramLoaded:function(){if(void 0!==this._glslProgram){for(var a=0;a<this._dpfList.length;a++)this._dpfList[a].setGLSLprogram(this._glslProgram),this._useUnifiedLayout&&(this._dpfList[a]._useUnifiedLayout=!0);console.log("GLSL Program Loaded")}},
...
DPFutils.fallbackBlackTex);this._annVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_ANN_UNIT,DPFutils.fallbackBlackTex);console.log("Fallbacks set")},home:function(){if(0==this._dpfList.length||void 0===this._dpfList[0])this._manip.setEyePosition([0,0,0]),this._manip.setTarget([0,10,0]);else{var a=void 0===this._closestDPF?this._dpfList[0].getPosition():this._closestDPF.getPosition();this._manip.setEyePosition(a)}this._manip.setNode(this._dpfGroup)},goExternalView:function(){if(void 0!==
this._closestDPF){var a=this._closestDPF.getPosition(),b=this._closestDPF.getDepthRange()[1],c=osg.vec3.create();c[0]=a[0]+1*b;c[1]=a[1]+1*b;c[2]=a[2]+.5*b;this._manip.setEyePosition(c);this._manip.setTarget(a)}},setFOV:function(a){this._fov=a;if(void 0!==this._viewer){var b=this._viewer.getCamera();if(void 0!==b){var c={};osg.mat4.getPerspective(c,b.getProjectionMatrix());osg.mat4.perspective(b.getProjectionMatrix(),DPF_DEG2RAD*a,c.aspectRatio,c.zNear,c.zFar)}}},getFOV:function(){return this._fov},
