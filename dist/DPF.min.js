...
a._direction[2],a._inviewDPFid=-1,a._insightTrans.setNodeMask(0),a.onTransitionEnded)a.onTransitionEnded()}else this._tReqNorm=(1-Math.cos(this._tReqNorm*Math.PI))/2,osg.vec3.lerp(a._eyePos,a._reqFrom,a._reqTo,this._tReqNorm);a._manip.setEyePosition(a._eyePos);if(void 0!==a.onTick)a.onTick();return!0}};
...
void 0)};
DPFhandler.prototype={_initGlobalUniforms:function(){this._ssGlobal=this._dpfGroup.getOrCreateStateSet();this._ssVis=this._stdVisionGroup.getOrCreateStateSet();this._ssAnn=this._annVisionGroup.getOrCreateStateSet();this._DIMweight=0;this._DIMcolor=osg.vec4.fromValues(0,0,0,this._DIMweight);this._tDIMdur=1;this._DOFweight=0;this._vPointerDir=osg.vec3.create();this._useUnifiedLayout=!1;this._ssGlobal.addUniform(osg.Uniform.createInt1(DPF_PANO_UNIT,"panoTex"));this._ssGlobal.addUniform(osg.Uniform.createInt1(DPF_DEPTH_UNIT,"depthTex"));
this._ssGlobal.addUniform(osg.Uniform.createInt1(DPF_ANN_UNIT,"annTex"));this._ssGlobal.addUniform(osg.Uniform.createFloat1(0,"time"));this._ssGlobal.addUniform(osg.Uniform.createInt1(0,"annotationHash"));this._ssGlobal.addUniform(osg.Uniform.createInt1(0,"bDepthVision"));this._ssGlobal.addUniform(osg.Uniform.createFloat4(this._DIMcolor,"dimColor"));this._ssGlobal.addUniform(osg.Uniform.createFloat2([this._DOFweight,0],"DOF"));this._ssGlobal.addUniform(osg.Uniform.createFloat3(osg.vec3.create(),"uViewDir"));
this._ssGlobal.addUniform(osg.Uniform.createFloat3(osg.vec3.create(),"uWorldEyePos"));this._ssVis.addUniform(osg.Uniform.createInt1(0,"bAnnotationVision"));this._ssAnn.addUniform(osg.Uniform.createInt1(1,"bAnnotationVision"))},run:function(){void 0===this._canvas?console.log("ERROR: you must provide a canvas element"):(void 0===this._viewer&&(this._viewer=new osgViewer.Viewer(this._canvas,{antialias:!1,enableFrustumCulling:!1,alpha:!0})),this._viewer.init(),this._viewer.setLightingMode(osgViewer.View.LightingMode.NO_LIGHT),
this._viewer.setSceneData(this._root),this._viewer.setManipulator(this._manip),this._manip.setNode(this._dpfGroup),this.setFOV(this._fov),this._viewer.run(),this._NFR=.0003,this._viewer.getCamera().setNearFarRatio(this._NFR),this._aRTTsize=[256,256],this._hoverAnn=0,this.initRTT(),this.initHUD(),this._time=0,this._attachListeners(),this._initGamePads())},_initGamePads:function(){this.gamepads=navigator.getGamepads()},_handlePositionalGamepad:function(a){},_handleGamepads:function(){for(var a=0;a<
this.gamepads.length;++a){var b=this.gamepads[a];if(b){for(var c=0;c<b.buttons.length;++c)b.buttons[c].pressed&&console.log("Pressed button "+c);b.pose&&this._handlePositionalGamepad(b)}}},useDeviceOrientation:function(a){void 0!==this._viewer&&(this._useDeviceOrientation=a,this._viewer.getEventProxy().DeviceOrientation.setEnable(a),a&&(this._annXYquery=[.5,.5]))},toggleDepthVision:function(){1===this._ssGlobal.getUniform("bDepthVision").getInternalArray()[0]?(this._ssGlobal.getUniform("bDepthVision").setInt(0),
this._bDepthVision=!1):(this._ssGlobal.getUniform("bDepthVision").setInt(1),this._bDepthVision=!0)},_handleDIM:function(){this._tDIM=(this._time-this._tDIMreq)/this._tDIMdur;1<=this._tDIM?(this._tDIMreq=-1,this._DIMcolor[3]=this._DIMweight):this._DIMcolor[3]=this._DIMweight*this._tDIM;this._ssGlobal.getUniform("dimColor").setFloat4(this._DIMcolor)},requestDIManimation:function(){0>=this._DIMweight||(this._tDIMreq=this._time)},resetDIM:function(){this._tDIMreq=-1;this._DIMcolor[3]=0;this._ssGlobal.getUniform("dimColor").setFloat4(this._DIMcolor)},
setDIMcolor:function(a){this._DIMcolor[0]=a[0];this._DIMcolor[1]=a[1];this._DIMcolor[2]=a[2]},setDIMweight:function(a){this._DIMweight=a},goNextDPFinView:function(a){if(!(2>this.getNumDPFs())){var b=this._inviewDPFid;0>b||(a=void 0===a?1:a,this.requestTransitionToDPF(this.getDPF(b),a))}},_triggerAnnSelect:function(){if(void 0!==this._activeDPF&&0!==this._hoverAnn){if(void 0!==this.onSelectAnnotation)this.onSelectAnnotation();var a=this._activeDPF._annotationList[this._hoverAnn];if(void 0!==a&&void 0!==
a.onSelect)a.onSelect()}},_attachListeners:function(){var a=this,b=function(b){b=a._fov+b;120<b&&(b=120);20>b&&(b=20);a.setFOV(b)};$(function(){$(document).keydown(function(c){32==c.keyCode&&a.home();107==c.keyCode&&(a._vrState||b(.5));109==c.keyCode&&(a._vrState||b(-.5));86==c.keyCode&&a.toggleVR();73==c.keyCode&&void 0!==a._activeDPF&&a._activeDPF.toggleInvertDepth();75==c.keyCode&&void 0!==a._activeDPF&&a.toggleDepthVision();81==c.keyCode&&void 0!==a._activeDPF&&a._activeDPF.toggleQuadraticDepth();
80==c.keyCode&&void 0!==a._activeDPF&&a._activeDPF.playOrPauseVideoStreams();88==c.keyCode&&a.toggleDebugCam();102==c.keyCode&&a.goNextDPFinView(1)})});Hammer(a._canvas).on("tap",function(b){a._useMobile||a._triggerAnnSelect()});Hammer(a._canvas).on("doubletap",function(b){a.goNextDPFinView(1);a._useMobile&&a._triggerAnnSelect()});var c=function(b){var c=a._canvas.width/a._canvas.clientWidth*b.clientX;b=a._canvas.height/a._canvas.clientHeight*(a._canvas.clientHeight-b.clientY);c/=a._canvas.width;
b/=a._canvas.height;a._annXYquery[0]=c;a._annXYquery[1]=b};a._bDragging=!1;a._bPointerDown=!1;var d=function(b){a._bDragging=!1;a._bPointerDown=!0;c(b)},e=function(b){a._bPointerDown&&(a._bDragging=!0);a._useMobile||a._vrState||a._useDeviceOrientation||c(b)},f=function(b){a._bDragging=!1;a._bPointerDown=!1},h=function(b){a._bDragging=!1;a._bPointerDown=!1};a._canvas.addEventListener("pointerdown",d);a._canvas.addEventListener("pointermove",e);a._canvas.addEventListener("pointerup",f);a._canvas.addEventListener("pointerout",
h);a._canvas.addEventListener("mousedown",d);a._canvas.addEventListener("mousemove",e);a._canvas.addEventListener("mouseup",f);a._canvas.addEventListener("mouseout",h);d=new DPFupdateCallback(a);a._root.addUpdateCallback(d)},preloadAll:function(){for(var a=0;a<this._dpfList.length;a++)this._preloadDPF(this._dpfList[a])},_create3Dpointer:function(){this._hoverAnnDepth=1;this._pointerModel=osg.createTexturedSphere(.03,20,20);var a=new osg.Material;a.setTransparency(1);a.setDiffuse([1,1,1,1]);this._pointerModel.getOrCreateStateSet().setAttributeAndModes(a);
...
this._insightModel.getOrCreateStateSet().setAttributeAndModes(new osg.BlendFunc,osg.StateAttribute.ON);this._insightModel.getOrCreateStateSet().setAttributeAndModes(new osg.Depth(osg.Depth.ALWAYS),osg.StateAttribute.OVERRIDE|osg.StateAttribute.ON);this._insightTrans=new osg.AutoTransform;this._insightTrans.setPosition([0,0,0]);this._insightTrans.setAutoRotateToScreen(!0);this._insightTrans.addChild(this._insightModel);this._dpfGroup.addChild(this._insightTrans);this._insightTrans.setNodeMask(0)},
_update3Dpointer:function(){this._pointerPos[0]=this._hoverAnnDepth*this._direction[0];this._pointerPos[1]=this._hoverAnnDepth*this._direction[1];this._pointerPos[2]=this._hoverAnnDepth*this._direction[2];this._pointerPos[0]+=this._eyePos[0];this._pointerPos[1]+=this._eyePos[1];this._pointerPos[2]+=this._eyePos[2];this._pointerTrans.setPosition(this._pointerPos)},_updateInsightDPF:function(){var a=this._dpfList[this._inviewDPFid];void 0!==a&&(this._preloadDPF(a),this._insightTrans.setPosition(a._position),
this._insightTrans.setNodeMask(15))},initRTT:function(){if(void 0!==this._viewer.getCamera()){this._aRTT=new osg.Camera;this._aRTT.addChild(this._annVisionGroup);this._aRTT.setName("rttCamera");this._aRTT.setClearColor(osg.vec4.create([0,0,0,1]));this._aRTT.setViewMatrix(this._viewer.getCamera().getViewMatrix());this._aRTT.setProjectionMatrix(this._viewer.getCamera().getProjectionMatrix());this._aRTT.setRenderOrder(osg.Camera.PRE_RENDER,0);this._aRTT.setReferenceFrame(osg.Transform.ABSOLUTE_RF);this._aRTT.setViewport(new osg.Viewport(0,
0,this._aRTTsize[0],this._aRTTsize[1]));this._aRTTttex=new osg.Texture;this._aRTTttex.setTextureSize(this._aRTTsize[0],this._aRTTsize[1]);this._aRTTttex.setInternalFormat(osg.Texture.RGB);this._aRTTttex.setMinFilter("NEAREST");this._aRTTttex.setMagFilter("NEAREST");this._aRTT.attachTexture(osg.FrameBufferObject.COLOR_ATTACHMENT0,this._aRTTttex);this._aRTT.attachRenderBuffer(osg.FrameBufferObject.DEPTH_ATTACHMENT,osg.FrameBufferObject.DEPTH_COMPONENT16);this._aRTTquad=osg.createTexturedQuadGeometry(5,
50,0,this._aRTTsize[0],0,0,0,this._aRTTsize[1],0);this._aRTTquad.getOrCreateStateSet().setTextureAttributeAndModes(0,this._aRTTttex);this._root.addChild(this._aRTT);var a=this;a._aRTTcanvasElem=document.createElement("canvas");a._aRTTctx=a._aRTTcanvasElem.getContext("2d");a._aRTTcanvasElem.width=a._aRTTsize[0];a._aRTTcanvasElem.height=a._aRTTsize[1];var b=4*a._aRTTcanvasElem.width;a._aRTTpixels=new Uint8Array(b*a._aRTTcanvasElem.height);var c=a._useMobile?.3:.05,d=void 0;a._tLastRTT=0;a._aRTT.setFinalDrawCallback(function(e){if(a._aEnabled&&
!a._bDepthVision&&a._bRTTcanRead&&!(a._time-a._tLastRTT<c||a._bDragging)&&(d=e.getGraphicContext(),d.checkFramebufferStatus(d.FRAMEBUFFER)===d.FRAMEBUFFER_COMPLETE)){d.readPixels(0,0,a._aRTTcanvasElem.width,a._aRTTcanvasElem.height,d.RGBA,d.UNSIGNED_BYTE,a._aRTTpixels);a._tLastRTT=a._time;var f=Math.floor(a._aRTTcanvasElem.height*a._annXYquery[1])*b+4*Math.floor(a._aRTTcanvasElem.width*a._annXYquery[0]);e=a._aRTTpixels[f];f=a._aRTTpixels[f+1];a._activeDPF&&(a._dNorm=f/255,f=a._activeDPF.getDepthRange(),
a._hoverAnnDepth=DPFutils.lerp(f[1],f[0],a._dNorm),a._hoverAnnDepth-=f[0]);e=Math.floor(e*DPF_ANN_HASH);e!==a._hoverAnn&&(a._hoverAnn=e,a._onChangeAnnotation())}})}},getHoveredAnnotationID:function(){return this._hoverAnn},_onChangeAnnotation:function(){this._ssGlobal.getUniform("annotationHash").setInt(this._hoverAnn);if(0<this._hoverAnn){if(void 0!==this.onHoverAnnotation)this.onHoverAnnotation();var a=this._activeDPF._annotationList[this._hoverAnn];if(void 0!==a&&void 0!==a.onHover)a.onHover();
this._vrState||(this._canvas.style.cursor="pointer")}else if(this._vrState||(this._canvas.style.cursor="auto"),void 0!==this.onLeaveAnnotation)this.onLeaveAnnotation()},initHUD:function(){void 0!==this._canvas&&(this._HUD=new osg.Camera,osg.mat4.ortho(this._HUD.getProjectionMatrix(),0,this._canvas.width,0,this._canvas.height,-5,5),osg.mat4.translate(this._HUD.getViewMatrix(),this._HUD.getViewMatrix(),[25,25,0]),this._HUD.setRenderOrder(osg.Camera.NESTED_RENDER,0),this._HUD.setReferenceFrame(osg.Transform.ABSOLUTE_RF),
void 0!==this._aRTTquad&&this._HUD.addChild(this._aRTTquad),this._root.addChild(this._HUD),this.toggleDebugCam(!1))},toggleDebugCam:function(a){void 0===a?15===this._aRTTquad.getNodeMask()?this._aRTTquad.setNodeMask(0):this._aRTTquad.setNodeMask(15):a?this._aRTTquad.setNodeMask(15):this._aRTTquad.setNodeMask(0)},loadShadersFromPath:function(a,b){var c=this;c._shadersPath=a;c._useUnifiedLayout=!1;void 0!==b&&void 0!==b.useUnifiedLayout&&(c._useUnifiedLayout=b.useUnifiedLayout);$.get(a+"/main.glsl",
function(a){c._useUnifiedLayout&&(a="#define DPF_USE_UNIFIED 1\n"+a);c._useMobile&&(a="#define DPF_MOBILE_DEVICE 1\n"+a);a+="\n";a=new osg.Program(new osg.Shader("VERTEX_SHADER","#define VERTEX_SH 1\n"+a),new osg.Shader("FRAGMENT_SHADER","#define FRAGMENT_SH 1\n"+a));c._glslProgram=a;c.onGLSLprogramLoaded()},"text")},onGLSLprogramLoaded:function(){if(void 0!==this._glslProgram){for(var a=0;a<this._dpfList.length;a++)this._dpfList[a].setGLSLprogram(this._glslProgram),this._useUnifiedLayout&&(this._dpfList[a]._useUnifiedLayout=
!0);console.log("GLSL Program Loaded")}},setupFallbacks:function(){this._stdVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_PANO_UNIT,DPFutils.fallbackWhiteTex);this._stdVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_DEPTH_UNIT,DPFutils.fallbackBlackTex);this._stdVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_ANN_UNIT,DPFutils.fallbackBlackTex);this._annVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_PANO_UNIT,DPFutils.fallbackBlackTex);
this._annVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_DEPTH_UNIT,DPFutils.fallbackBlackTex);this._annVisionGroup.getOrCreateStateSet().setTextureAttributeAndModes(DPF_ANN_UNIT,DPFutils.fallbackBlackTex);console.log("Fallbacks set")},home:function(){if(0==this._dpfList.length||void 0===this._dpfList[0])this._manip.setEyePosition([0,0,0]),this._manip.setTarget([0,10,0]);else{var a=void 0===this._activeDPF?this._dpfList[0].getPosition():this._activeDPF.getPosition();this._manip.setEyePosition(a)}this._manip.setNode(this._dpfGroup)},
goExternalView:function(){if(void 0!==this._activeDPF){var a=this._activeDPF.getPosition(),b=this._activeDPF.getDepthRange()[1],c=osg.vec3.create();c[0]=a[0]+1*b;c[1]=a[1]+1*b;c[2]=a[2]+.5*b;this._manip.setEyePosition(c);this._manip.setTarget(a)}},setFOV:function(a){this._fov=a;if(void 0!==this._viewer){var b=this._viewer.getCamera();if(void 0!==b){var c={};osg.mat4.getPerspective(c,b.getProjectionMatrix());osg.mat4.perspective(b.getProjectionMatrix(),DPF_DEG2RAD*a,c.aspectRatio,c.zNear,c.zFar)}}},
getFOV:function(){return this._fov},setDOF:function(a){this._DOFweight=a},getDOF:function(){return this._DOFweight},addDPF:function(a){this._dpfList.push(a);this._stdVisionGroup.addChild(a.getTransNode());this._annVisionGroup.addChild(a.getTransNode());void 0!==this._glslProgram&&a.setGLSLprogram(this._glslProgram);console.log("Added new DPF")},getDPF:function(a){return this._dpfList[a]},getDPFbyName:function(a){for(var b=0;b<this._dpfList.length;b++)if(this._dpfList[b]._uniqueName===a)return this._dpfList[b]},
getNumDPFs:function(){return this._dpfList.length},useUnifiedLayout:function(a){this._useUnifiedLayout=a},isUsingUnifiedLayout:function(){return this._useUnifiedLayout},requestTransitionToLocation:function(a,b){0<=this._tMoveReq||(this._tMoveReq=this._time,this._tMoveDur=b,this._reqTo=a,this._reqFrom=this._eyePos)},duringTransition:function(){return 0<=_tMoveReq},requestTransitionToDPF:function(a,b){if(void 0!==this._manip&&void 0!==a){console.log("Requested transition to "+a._uniqueName);if(void 0!==
this.onTransitionRequest)this.onTransitionRequest();void 0===b?this._manip.setEyePosition(a.getPosition()):this.requestTransitionToLocation(a.getPosition(),b)}},requestTransitionToDPFbyIndex:function(a,b){a=this._dpfList[a];void 0!==a&&this.requestTransitionToDPF(a,b)},requestTransitionToDPFbyName:function(a,b){a=this.getDPFbyName(a);void 0!==a&&this.requestTransitionToDPF(a,b)},parseXML:function(a,b){var c=a.substring(0,a.lastIndexOf("/")+1),d=void 0,e=void 0,f=void 0,h=this;console.log("Loading XML: "+
a+"...");$.get(a,function(a){c+=$(a).find("basepath").text();var g=$(a).find("postfix");void 0!==g&&(void 0!==g.attr("color")&&(d=g.attr("color")),void 0!==g.attr("depth")&&(e=g.attr("depth")),void 0!==g.attr("annotation")&&(f=g.attr("annotation")));$(a).find("DPF").each(function(a){a=new DPF;h.addDPF(a);console.log("Parsing DPF...");var b=$(this).find("position");void 0!==b.attr("x")&&void 0!==b.attr("y")&&void 0!==b.attr("z")&&a.setPosition([parseFloat(b.attr("x")),parseFloat(b.attr("y")),parseFloat(b.attr("z"))]);
b=$(this).find("orientation");void 0!==b.attr("x")&&void 0!==b.attr("y")&&void 0!==b.attr("z")&&a.setOrientationFromEulerVector([parseFloat(b.attr("x")),parseFloat(b.attr("y")),parseFloat(b.attr("z"))]);b=$(this).find("name");void 0!==b&&(b=b.text(),a.setUniqueName(b),d&&a.setPanoPath(c+b+d,c+"lo_"+b+d),e&&a.setDepthPath(c+b+e),f&&a.setSemanticPath(c+b+f));b=$(this).find("depthrange");void 0!==b&&void 0!==b.attr("min")&&void 0!==b.attr("max")&&a.setDepthRange(parseFloat(b.attr("min")),parseFloat(b.attr("max")))});
h.home();void 0!==b&&b()}).fail(function(){console.log("ERROR Loading XML")})},_preloadDPF:function(a){void 0!==a&&(a._bLoaded[0]||a._bLoading[0]||a.requestPano(),this._useUnifiedLayout||(a._bLoaded[1]||a._bLoading[1]||a.requestDepth(),a._bLoaded[2]||a._bLoading[2]||a.requestSemantic()))},inVRmode:function(){return this._vrState},toggleVR:function(){var a=this._viewer;a.getVRDisplay()?a.setPresentVR(!this._vrState).then(this._switchVR.bind(this)):this._switchVR()},_switchVR:function(){var a=this._viewer;
a.setPresentVR(!this._vrState);if(this._vrState)a._eventProxy.WebVR.setEnable(!1),a._eventProxy.DeviceOrientation.setEnable(!1),this._root.removeChild(this._vrNode),this._root.addChild(this._dpfGroup),this._pointerTrans.setNodeMask(0);else for(this._root.removeChild(this._dpfGroup),this._vrNode||(navigator.getVRDisplays?(a.getEventProxy().WebVR.setEnable(!0),this._vrNode=osgUtil.WebVR.createScene(a,this._dpfGroup,a._eventProxy.WebVR.getHmd())):(a.getEventProxy().DeviceOrientation.setEnable(!0),this._vrNode=
osgUtil.WebVRCustom.createScene(a,this._dpfGroup,{isCardboard:!0,vResolution:this._canvas.height,hResolution:this._canvas.width}))),this._root.addChild(this._vrNode),this._annXYquery=[.5,.5],this._pointerTrans.setNodeMask(15),this.home(),a=0;a<this._vrNode.children.length;a++)this._vrNode.children[a]._nearFarRatio=this._NFR;this._vrState=!this._vrState}};